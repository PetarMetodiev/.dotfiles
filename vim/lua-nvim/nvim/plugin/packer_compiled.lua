...
_G.packer_plugins = {
  ...
  ["nvim-hlslens"] = {
    ...
    loaded = true,
    path = "/Users/pmetodiev/.local/share/nvim/site/pack/packer/start/nvim-hlslens"
  },
  ["nvim-tree.lua"] = {
    config = { "\27LJ\2\n1\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\22configs.nvim-tree\frequire\0" },
    loaded = true,
    path = "/Users/pmetodiev/.local/share/nvim/site/pack/packer/start/nvim-tree.lua"
  },
  ["nvim-treesitter"] = {
  ...
  ["pears.nvim"] = {
    ...
    loaded = true,
    path = "/Users/pmetodiev/.local/share/nvim/site/pack/packer/start/pears.nvim"
  },
  tcomment_vim = {
    loaded = true,
  ...
  ["vim-lastplace"] = {
    loaded = true,
    path = "/Users/pmetodiev/.local/share/nvim/site/pack/packer/start/vim-lastplace"
  },
  ["vim-obsession"] = {
    loaded = true,
